...
public class LunarUtils {
    ...
    private static String getChinaDayString(int day) {
        ...
        return day > 30?"":(day == 10?"初十":chineseTen[day / 10] + chineseNumber[n]);
    }

    public String toString() {
        return (this.leap?"闰":"") + this.monthToOld(chineseNumber[this.month - 1] + "月") + getChinaDayString(this.day);
    }

    private String monthToOld(String str) {
        return str.equals("一月")?"正月":(str.equals("十一月")?"冬月":(str.equals("十二月")?"腊月":str));
    }
}